...
- `nuke-aws-lab-resources.sh` scans enabled regions and deletes EC2 instances, EC2 key pairs, VPC dependencies, and non-default VPCs. It defaults to dry-run and requires `--confirm-delete` before making changes.
